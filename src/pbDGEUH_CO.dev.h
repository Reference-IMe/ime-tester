...
#ifndef __pbDGEUH_CO_DEV_H__
#define __pbDGEUH_CO_DEV_H__

__attribute__((always_inline)) inline void pbDGEUH_CO_dev (	int mpi_rank_row_in_col, int mpi_rank_col_in_row, int myrows, int mycols, int m,
