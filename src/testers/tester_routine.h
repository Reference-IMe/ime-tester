...
test_result tester_routine(const char* routine_name, int verbosity, test_input routine_input, int rank, int failing_rank, int failing_level, int checkpoint_skip_interval)
{
	test_result info;
...
*/
	...
	else if	( strcmp( routine_name, SPK_SV_FAULT_0_TOLERANT_1 ) == 0 )	info = test_ScaLAPACK_pDGESV_ft1(routine_name, verbosity, routine_input, rank, -1, checkpoint_skip_interval);
	else if	( strcmp( routine_name, SPK_SV_FAULT_1_TOLERANT_1 ) == 0 )	info = test_ScaLAPACK_pDGESV_ft1(routine_name, verbosity, routine_input, rank, failing_level, checkpoint_skip_interval);

	else if	( strcmp( routine_name, SPK_LU ) 					== 0 )	info = test_ScaLAPACK_pDGETRF    (routine_name, verbosity, routine_input, rank);
	else if	( strcmp( routine_name, SPK_LU_FAULT_0_TOLERANT_1 ) == 0 )	info = test_ScaLAPACK_pDGETRF_ft1(routine_name, verbosity, routine_input, rank, -1, checkpoint_skip_interval);
	else if	( strcmp( routine_name, SPK_LU_FAULT_1_TOLERANT_1 ) == 0 )	info = test_ScaLAPACK_pDGETRF_ft1(routine_name, verbosity, routine_input, rank, failing_level, checkpoint_skip_interval);

	else if	( strcmp( routine_name, SPK_QR ) 					== 0 )	info = test_ScaLAPACK_pDGEQRF    (routine_name, verbosity, routine_input, rank);
	else if	( strcmp( routine_name, SPK_QR_FAULT_0_TOLERANT_1 ) == 0 )	info = test_ScaLAPACK_pDGEQRF_ft1(routine_name, verbosity, routine_input, rank, -1, checkpoint_skip_interval);
	else if	( strcmp( routine_name, SPK_QR_FAULT_1_TOLERANT_1 ) == 0 )	info = test_ScaLAPACK_pDGEQRF_ft1(routine_name, verbosity, routine_input, rank, failing_level, checkpoint_skip_interval);
