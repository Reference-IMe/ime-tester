...
test_result test_ScaLAPACK_pDGETRF_ft1(const char* label, int verbosity, parallel_env env, test_input input, int failing_level, int checkpoint_freq)
{
	...
	output = ScaLAPACK_pDGETRF_ft1(input.n, A, input.scalapack_bf, env.mpi_rank, input.calc_procs, input.spare_procs, \
