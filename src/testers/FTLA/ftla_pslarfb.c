...
/* 
 * @generated s Sun Nov 17 06:57:04 2013
 */

/* pslarfb.f -- translated by f2c (version 20061008).
...
static float c_b21 = 0.;
static float c_b22 = 1.;
static float c_b48 = -1.;
static int c_n1 = -1;

/* Subroutine */ int ftla_pslarfb(char *side, char *trans, char *direct, char *
        storev, int *m, int *n, int *k, float *v, int *
        iv, int *jv, int *descv, float *t, float *c__, 
        int *ic, int *jc, int *descc, float *work, ftnlen 
        side_len, ftnlen trans_len, ftnlen direct_len, ftnlen storev_len, ftla_work_t *ftw)
{
    ...
    extern /* Subroutine */ int sgemm_(char *, char *, int *, int *, 
            ...
            int *, float *, float *, int *, ftnlen, ftnlen);
    extern logical lsame_(char *, char *, ftnlen, ftnlen);
    static int ileft, ioffv, npcol, ivcol, icrow, mycol;
    extern /* Subroutine */ int strmm_(char *, char *, char *, char *, 
            int *, int *, float *, float *, int *, 
            float *, int *, ftnlen, ftnlen, ftnlen, ftnlen);
    static int ictxt, iinxt, jjnxt, nprow, ivrow, myrow, icoffc, height, 
               iroffc, icoffv;
    extern /* Subroutine */ int slacpy_(char *, int *, int *, 
            float *, int *, float *, int *, ftnlen), 
           slaset_(char *, int *, int *, float *, float *, 
                   float *, int *, ftnlen);
    ...
    extern int numroc_(int *, int *, int *, int *, 
            int *);
    static int mydist;
    extern /* Subroutine */ int sgebr2d_(int *, char *, char *, int *,
            int *, float *, int *, int *, int *, ftnlen,
            ftnlen);
    static char transt[1];
    extern /* Subroutine */ int sgebs2d_(int *, char *, char *, int *,
            int *, float *, int *, ftnlen, ftnlen), infog1l_(
                int *, int *, int *, int *, int *, int *, 
                int *), infog2l_(int *, int *, int *, int *, 
                    int *, int *, int *, int *, int *, int *, 
                    int *), strbr2d_(int *, char *, char *, char *, char *, 
                        int *, int *, float *, int *, int *, int 
                        *, ftnlen, ftnlen, ftnlen, ftnlen), dgsum2d_(int *, char *, 
                            char *, int *, int *, float *, int *, int *, 
                            int *, ftnlen, ftnlen), strbs2d_(int *, char *, char *, 
                                char *, char *, int *, int *, float *, int *, 
                                ftnlen, ftnlen, ftnlen, ftnlen), pbztran_(int *, char *, char 
                                    *, int *, int *, int *, float *, int *, 
                                    float *, float *, int *, int *, int *, 
                                    int *, int *, float *, ftnlen, ftnlen);
    ...
    if (lsame_(storev, "C", (ftnlen)1, (ftnlen)1)) 
    {
        ...
        if (lsame_(side, "L", (ftnlen)1, (ftnlen)1)) 
        {
            ...
            if ( !Cftla_replay( ftw ) ) {
                ...
                if (mycol == ivcol) 
                {
                    sgebs2d_(&ictxt, "Rowwise", rowbtop, &mpc, k, &v[ioffv], &ldv, (ftnlen)7, (ftnlen)1);
                    if (myrow == ivrow) 
                    {
                        strbs2d_(&ictxt, "Rowwise", rowbtop, uplo, "Non unit", k, 
                                k, &t[1], &nbv, (ftnlen)7, (ftnlen)1, (ftnlen)1, (ftnlen)8);
                    }
                    slacpy_("All", &mpc, k, &v[ioffv], &ldv, &work[ipv], &lv, (ftnlen)3);
                } 
                else 
                {
                    sgebr2d_(&ictxt, "Rowwise", rowbtop, &mpc, k, &work[ipv], &lv,
                            &myrow, &ivcol, (ftnlen)7, (ftnlen)1);
                    if (myrow == ivrow) 
                    {
                        strbr2d_(&ictxt, "Rowwise", rowbtop, uplo, "Non unit", k, 
...
L10:
                    if (*k - itop > 0) 
                    {
                        i__1 = iinxt - iibeg + 1;
                        i__2 = *k - itop;
                        slaset_("Upper", &i__1, &i__2, &c_b21, &c_b22, &work[ipv 
...
L20:
                if (jj <= jjv + *k - 1) 
                {
                    height = ibase - itop;
                    i__1 = itop - jj + jjv;
                    slaset_("All", &kp, &i__1, &c_b21, &c_b21, &work[ipv + ii 
                            - iiv + (jj - jjv) * lv], &lv, (ftnlen)3);
                    slaset_("Lower", &kp, &height, &c_b21, &c_b22, &work[ipv 
            ...
            if ( !Cftla_replay( ftw ) ) {
                if (mpc > 0) 
                {
                    sgemm_("Transpose", "No transpose", &nqc, k, &mpc, &c_b22, &
                            c__[ioffc], &ldc, &work[ipv], &lv, &c_b21, &work[ipw],
                            &lw, (ftnlen)9, (ftnlen)12);
                } 
                else 
                {
                    slaset_("All", &nqc, k, &c_b21, &c_b21, &work[ipw], &lw, (ftnlen)3);
                }
            ...
            if ( !Cftla_replay( ftw ) ) {
                if (myrow == ivrow) 
                {
                    ...
                    strmm_("Right", uplo, transt, "Non unit", &nqc, k, &c_b22, &t[1], &nbv, // transt = 'N'
                            &work[ipw], &lw, (ftnlen)5, (ftnlen)1, (ftnlen)1, (ftnlen)8);

                    sgebs2d_(&ictxt, "Columnwise", " ", &nqc, k, &work[ipw], &lw, 
                            (ftnlen)10, (ftnlen)1);
                } 
                else 
                {
                    sgebr2d_(&ictxt, "Columnwise", " ", &nqc, k, &work[ipw], &lw, 
                            &ivrow, &mycol, (ftnlen)10, (ftnlen)1);
                }
                if( Cftla_procfailed( ftw, *jv ) ) return -1;
            }
            ...
            if ( !Cftla_replay( ftw ) ) {
                sgemm_("No transpose", "Transpose", &mpc, &nqc, k, &c_b48, &work[ipv], &lv, 
                        &work[ipw], &lw, &c_b22, &c__[ioffc], &ldc, (ftnlen)12, (ftnlen)9);
#ifdef INJECT
                sinject_errors(errors, *jv, &v[1], &descv[1], ftw );
#endif /* INJECT */
                if( Cftla_procfailed( ftw, *jv ) ) return -1;
            }
        ...
        else 
        {
            ...
            if (mycol == ivcol) {
                if (myrow == ivrow) {
                    slaset_("All", &iroffv, k, &c_b21, &c_b21, &work[ipw], &
                            lw, (ftnlen)3);
                    ipw1 = ipw + iroffv;
                    slacpy_("All", &npv, k, &v[ioffv], &ldv, &work[ipw1], &lw,
                            (ftnlen)3);
                } else {
                    ipw1 = ipw;
                    slacpy_("All", &npv, k, &v[ioffv], &ldv, &work[ipw1], &lw,
...
L30:
                    if (*k - itop > 0) {
                        i__1 = iinxt - iibeg + 1;
                        i__2 = *k - itop;
                        slaset_("Upper", &i__1, &i__2, &c_b21, &c_b22, &work[
...
L40:
                    if (jj <= jjv + *k - 1) {
                        height = ibase - itop;
                        i__1 = itop - jj + jjv;
                        slaset_("All", &kp, &i__1, &c_b21, &c_b21, &work[ipw1 
                                + ii - iiv + (jj - jjv) * lw], &lw, (ftnlen)3)
                            ;
                        slaset_("Lower", &kp, &height, &c_b21, &c_b22, &work[
            ...
            if (nqc > 0) {
                sgemm_("No transpose", "Transpose", &mpc, k, &nqc, &c_b22, &
                        c__[ioffc], &ldc, &work[ipv], &lv, &c_b21, &work[ipw],
                        &lw, (ftnlen)12, (ftnlen)9);
            } else {
                slaset_("All", &mpc, k, &c_b21, &c_b21, &work[ipw], &lw, (
                            ftnlen)3);
            }
            ...
            if (mycol == ivcol) {
                if (myrow == ivrow) {
                    ...
                    strbs2d_(&ictxt, "Columnwise", " ", uplo, "Non unit", k, 
                            k, &t[1], &nbv, (ftnlen)10, (ftnlen)1, (ftnlen)1, 
                            (ftnlen)8);
                } else {
                    strbr2d_(&ictxt, "Columnwise", " ", uplo, "Non unit", k, 
                            k, &t[1], &nbv, &ivrow, &mycol, (ftnlen)10, (
                                ftnlen)1, (ftnlen)1, (ftnlen)8);
                }
                strmm_("Right", uplo, trans, "Non unit", &mpc, k, &c_b22, &t[
                        1], &nbv, &work[ipw], &lw, (ftnlen)5, (ftnlen)1, (
                            ftnlen)1, (ftnlen)8);

                sgebs2d_(&ictxt, "Rowwise", " ", &mpc, k, &work[ipw], &lw, (
                            ftnlen)7, (ftnlen)1);
            } else {
                sgebr2d_(&ictxt, "Rowwise", " ", &mpc, k, &work[ipw], &lw, &
                        myrow, &ivcol, (ftnlen)7, (ftnlen)1);
            }
            ...
            sgemm_("No transpose", "No transpose", &mpc, &nqc, k, &c_b48, &
    ...
    else 
    {
        ...
        if (lsame_(side, "L", (ftnlen)1, (ftnlen)1)) {
            ...
            if (myrow == ivrow) {
                if (mycol == ivcol) {
                    slaset_("All", k, &icoffv, &c_b21, &c_b21, &work[ipw], &
                            lw, (ftnlen)3);
                    ipw1 = ipw + icoffv * lw;
                    slacpy_("All", k, &mqv, &v[ioffv], &ldv, &work[ipw1], &lw,
                            (ftnlen)3);
                } else {
                    ipw1 = ipw;
                    slacpy_("All", k, &mqv, &v[ioffv], &ldv, &work[ipw1], &lw,
...
L50:
                    if (*k - ileft > 0) {
                        i__1 = *k - ileft;
                        i__2 = jjnxt - jjbeg + 1;
                        slaset_("Lower", &i__1, &i__2, &c_b21, &c_b22, &work[
...
L60:
                    if (ii <= iiv + *k - 1) {
                        wide = iright - ileft;
                        i__1 = ileft - ii + iiv;
                        slaset_("All", &i__1, &kq, &c_b21, &c_b21, &work[ipw1 
                                + ii - iiv + (jj - jjv) * lw], &lw, (ftnlen)3)
                            ;
                        slaset_("Upper", &wide, &kq, &c_b21, &c_b22, &work[
            ...
            if (mpc > 0) {
                ...
                slaset_("All", &nqc, k, &c_b21, &c_b21, &work[ipw], &lw, (
                            ftnlen)3);
            }
            ...
            if (myrow == ivrow) {
                if (mycol == ivcol) {
                    ...
                    strbs2d_(&ictxt, "Rowwise", " ", uplo, "Non unit", k, k, &
                            t[1], &mbv, (ftnlen)7, (ftnlen)1, (ftnlen)1, (
                                ftnlen)8);
                } else {
                    strbr2d_(&ictxt, "Rowwise", " ", uplo, "Non unit", k, k, &
                            t[1], &mbv, &myrow, &ivcol, (ftnlen)7, (ftnlen)1, 
                            (ftnlen)1, (ftnlen)8);
                }
                strmm_("Right", uplo, transt, "Non unit", &nqc, k, &c_b22, &t[
            ...
            sgemm_("No transpose", "Transpose", &mpc, &nqc, k, &c_b48, &work[
            ...
            pb_topget_(&ictxt, "Broadcast", "Columnwise", colbtop, (ftnlen)9,
                    (ftnlen)10, (ftnlen)1);
            if (myrow == ivrow) {
                sgebs2d_(&ictxt, "Columnwise", colbtop, k, &nqc, &v[ioffv], &
                        ldv, (ftnlen)10, (ftnlen)1);
                if (mycol == ivcol) {
                    strbs2d_(&ictxt, "Columnwise", colbtop, uplo, "Non unit", 
                            k, k, &t[1], &mbv, (ftnlen)10, (ftnlen)1, (ftnlen)
                            1, (ftnlen)8);
                }
                slacpy_("All", k, &nqc, &v[ioffv], &ldv, &work[ipv], &lv, (
                            ftnlen)3);
            } else {
                sgebr2d_(&ictxt, "Columnwise", colbtop, k, &nqc, &work[ipv], &
                        lv, &ivrow, &mycol, (ftnlen)10, (ftnlen)1);
                if (mycol == ivcol) {
                    strbr2d_(&ictxt, "Columnwise", colbtop, uplo, "Non unit", 
...
L70:
                if (*k - ileft > 0) {
                    i__1 = *k - ileft;
                    i__2 = jjnxt - jjbeg + 1;
                    slaset_("Lower", &i__1, &i__2, &c_b21, &c_b22, &work[ipv 
...
L80:
                if (ii <= iiv + *k - 1) {
                    wide = iright - ileft;
                    i__1 = ileft - ii + iiv;
                    slaset_("All", &i__1, &kq, &c_b21, &c_b21, &work[ipv + ii 
                            - iiv + (jj - jjv) * lv], &lv, (ftnlen)3);
                    slaset_("Upper", &wide, &kq, &c_b21, &c_b22, &work[ipv + 
