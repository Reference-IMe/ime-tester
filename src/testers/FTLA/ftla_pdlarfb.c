...
/* 
 * @generated d Sun Nov 17 06:57:04 2013
 */
...
/* Subroutine */ int ftla_pdlarfb(char *side, char *trans, char *direct, char *
        ...
        side_len, ftnlen trans_len, ftnlen direct_len, ftnlen storev_len, ftla_work_t *ftw)
{
    ...
    extern /* Subroutine */ int dgebr2d_(int *, char *, char *, int *,
            int *, double *, int *, int *, int *, ftnlen,
            ftnlen);
    static char transt[1];
    extern /* Subroutine */ int dgebs2d_(int *, char *, char *, int *,
            int *, double *, int *, ftnlen, ftnlen), infog1l_(
...
#ifdef INJECT
                dinject_errors(errors, *jv, &v[1], &descv[1], ftw );
#endif /* INJECT */
                if( Cftla_procfailed( ftw, *jv ) ) return -1;
            }
