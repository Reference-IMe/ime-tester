...
#include "../pviDGESV_WO_blind.h"

double test_IMe_pviDGESV_blind(const char* label, int verbosity, int rows, int cols, int nrhs, int rank, int nprocs)
{
	clock_t start, stop;
	double** A2;
	double** bb;
	...
	pviDGESV_WO_blind(rows, A2, nrhs, bb, xx, rank, nprocs);
