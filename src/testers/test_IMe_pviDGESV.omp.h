...
#include "../pviDGESV_WO.omp.h"
#include "../helpers/info.h"
#include "../helpers/macros.h"
#include "../helpers/matrix.h"


duration_t test_IMe_pviDGESV_omp(const char* label, int verbosity, int rows, int cols, int nrhs, int rank, int cprocs, int sprocs)
{
	...
	if (i_calc)
	{
		...
		info = pviDGESV_WO_omp(rows, A2, nrhs, bb, xx, comm_calc);
