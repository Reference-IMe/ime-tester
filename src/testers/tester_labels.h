...
#define IME_SV_FAULT_1_TOLERANT_1 	"IMe-SV-ft1/1"

#define IME_XK						"IMe-XK"
#define IME_XK_FAULT_0_TOLERANT_1	"IMe-XK-ft1/0"
#define IME_XK_FAULT_1_TOLERANT_1	"IMe-XK-ft1/1"
