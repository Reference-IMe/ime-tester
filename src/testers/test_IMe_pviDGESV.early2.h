...
#include "../pviDGESV_WO.early2.h"


duration_t test_IMe_pviDGESV_early2(const char* label, int verbosity, int rows, int cols, int nrhs, int rank, int cprocs, int sprocs)
{
	...
	if (i_calc)
	{
		...
		info = pviDGESV_WO_early2(rows, A2, nrhs, bb, xx, comm_calc);
