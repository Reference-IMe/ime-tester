      SUBROUTINE PDGETF2NOPIV( M, N, A, IA, JA, DESCA, IPIV, INFO )
*
...
*
*           AVOID pivoting but do the rest
*
*           by searching the max on the single element vector below
*           the diagonal
            CALL PDAMAX( 1, GMAX, IPIV( IIA+J-JA ), A, I, J,
     $                   DESCA, 1 )
...
*
            IF( J-JA+1.LT.MN ) THEN
               CALL PDGER( M-J+JA-1, N-J+JA-1, -ONE,
     $                       A, I+1, J, DESCA,
