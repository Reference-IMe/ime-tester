...
test_result test_FTLA_pDGETRF(const char* label, int verbosity, test_input input, int rank, int faults)
{
	...
	output = FTLA_ftdtr(input.n, A, input.scalapack_bf, rank, input.calc_procs, faults);
