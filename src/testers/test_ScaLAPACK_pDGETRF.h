...
test_result test_ScaLAPACK_pDGETRF(const char* label, int verbosity, test_input input, int rank)
{
	...
	output = ScaLAPACK_pDGETRF(input.n, A, input.scalapack_bf, rank, input.calc_procs);
