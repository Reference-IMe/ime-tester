...
#ifndef __pDGEIT_W_async_H__
#define __pDGEIT_W_async_H__

void pDGEIT_W_async(double** A, double** Tlocal, double** TlastK, int n, MPI_Comm comm, int rank, int cprocs, int* map, int* global, int* local)
{
	int i,j;
