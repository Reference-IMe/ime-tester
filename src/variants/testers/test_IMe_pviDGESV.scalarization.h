...
#include "../pviDGESV_WO.scalarization.h"


duration_t test_IMe_pviDGESV_scalarization(const char* label, int verbosity, int rows, int cols, int nrhs, int rank, int cprocs, int sprocs)
{
	...
	if (i_calc)
	{
		...
		info = pviDGESV_WO_scalarization(rows, A2, nrhs, bb, xx, comm_calc);
