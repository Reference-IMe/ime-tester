...
#ifndef __pvDGEIT_WX_1D_H__
#define __pvDGEIT_WX_1D_H__

void pvDGEIT_WX(double** A, double** Xlocal, double** Klocal, double** lastK, int n, int bf, MPI_Comm comm, int rank, int cprocs, int* map, int* global, int* local)
{
	int i,j;
