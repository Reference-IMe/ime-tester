 ...
 *
 */
test_output pviDGESV_WO_u3ge(int nb, int n, double** A, int m, double** bb, double** xx, MPI_Comm comm)
{
	/*
	...
	pvDGEIT_WX(A, Xlocal, Klocal, lastK, n, nb, comm, rank, cprocs, map, global, local);		// init inhibition table
