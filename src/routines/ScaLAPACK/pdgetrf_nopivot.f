      SUBROUTINE PDGETRFNOPIV( M, N, A, IA, JA, DESCA, IPIV, INFO )
*
...
*     .. External Subroutines ..
     ...
     $                   PB_TOPGET, PB_TOPSET, PDGEMM, PDGETF2NOPIV,
...
*     singularity.
*
      CALL PDGETF2NOPIV( M, JB, A, IA, JA, DESCA, IPIV, INFO )
*
      IF( JB+1.LE.N ) THEN
*
...
*        singularity.
*
         CALL PDGETF2NOPIV( M-J+JA, JB, A, I, J, DESCA, IPIV, IINFO )
*
